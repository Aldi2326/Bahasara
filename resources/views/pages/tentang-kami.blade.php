    ...
    <main>
        ...
        <!-- Hero / Deskripsi -->
        <section class="d-flex align-items-center position-relative text-dark" style="min-height: 100vh;" data-aos="fade-up">
            <!-- Background Image -->
                ...
                <div class="row justify-content-center g-4">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                        <div class="card shadow border-0 text-center h-100">
                            <img src="{{ asset('assets/img/map-laptop.jpeg') }}"
                                class="card-img-top rounded-top"
                                alt="Misi 1"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                <p class="mb-0">Mendokumentasikan bahasa dan sastra daerah di Provinsi Jambi secara digital.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="card shadow border-0 text-center h-100">
                            <img src="{{ asset('assets/img/indonesia-students.jpg') }}"
                                class="card-img-top rounded-top"
                                alt="Misi 2"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                <p class="mb-0">Menyediakan akses informasi bagi peneliti, pelajar, dan masyarakat umum.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="card shadow border-0 text-center h-100">
                            <img src="{{ asset('assets/img/tudung-lingkup.jpg') }}"
                                ...
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                <p class="mb-0">Meningkatkan kesadaran masyarakat tentang pentingnya pelestarian budaya lokal.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 mt-4" data-aos="zoom-in" data-aos-delay="400">
                        <div class="card shadow border-0 text-center h-100">
                            <img src="{{ asset('assets/img/collaboration.jpg') }}"
                                class="card-img-top rounded-top"
                                alt="Misi 4"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                <p class="mb-0">Mendukung kolaborasi dengan lembaga pendidikan, komunitas, dan pemerintah daerah.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 mt-4" data-aos="zoom-in" data-aos-delay="500">
                        <div class="card shadow border-0 text-center h-100">
                            <img src="{{ asset('assets/img/jambi-budaya.png') }}"
                                class="card-img-top rounded-top"
                                alt="Misi 5"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body">
        ...
        <!-- Statistik Data -->
        <section id="statistik" class="py-5 bg-white" style="" data-aos="fade-up">
            <div class="container">
