    ...
    <div class="card shadow-lg border-0 rounded-3">
        ...
        <div class="card-body">
            ...
            <div class="mb-4" data-aos="fade-right" data-aos-duration="700">
                ...
                <span
                    class="badge 
            @if (strtolower($sastra->jenis) == 'lisan') bg-success text-white
            @elseif (strtolower($sastra->jenis) == 'tulisan') bg-warning text-white
            ...
            <div class="mb-4" data-aos="fade-left" data-aos-duration="700">
                ...
                <div class="d-flex align-items-start gap-2">
                    ...
                    <p class="mb-0 text-dark fs-6">
                        {!! $sastra->alamat ?? 'Alamat tidak tersedia.' !!}
                    </p>
                </div>
            </div>
            ...
            <div class="mb-5 text-center" data-aos="fade-up" data-aos-duration="900">
                ...
                <div class="ratio ratio-16x9 shadow mb-3">
                    <iframe src="{{ $filePath }}"
                        title="Dokumen PDF {{ $sastra->nama_sastra }}"
                        class="rounded"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Ambil file GeoJSON wilayah sastra
