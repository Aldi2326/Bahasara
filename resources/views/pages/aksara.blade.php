...
@section('title', 'Peta Aksara Provinsi Jambi')
...
<div class="mt-5 pt-4">
    <div style="position: relative;">
        ...
        <!-- Filter -->
        <form action="{{ route('peta.aksara') }}" method="GET" class="search-control-input flex gap-2">
            <input
                type="text"
                name="search"
                placeholder="Cari aksara atau wilayah..."
        ...
        <form action="{{ route('peta.aksara') }}" method="GET" id="filterForm">
            <div class="search-control d-flex flex-wrap gap-3">
                ...
                <div class="dropdown" style="margin-right: 10px;">
                    ...
                    <div class="dropdown-menu p-2" style="max-height: 250px; overflow-y: auto;" id="aksaraListDropdown">
                        <div>
                        ...
                        <div>
                            <label class="dropdown-item d-flex align-items-center gap-2">
                                <input class="form-check-input aksara-checkbox" type="checkbox" name="aksara[]"
                                    value="{{ $a->nama_aksara }}"
                                    {{ !empty($selectedAksara) && in_array($a->nama_aksara, $selectedAksara) ? 'checked' : '' }}>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu p-2" style="max-height: 250px; overflow-y: auto;" id="wilayahListDropdown">
                        <div>
                            <label class="dropdown-item d-flex align-items-center gap-2">
        ...
        <div id="legendCard" class="legend-card shadow">
            ...
            <div id="legendContent" class="legend-content">
                ...
                <div class="legend-item">
                    <span class="legend-color" style="background: {{ $a->warna_pin ?? '#1E90FF' }}"></span>
                    {{ $a->nama_aksara }}
                </div>
                @endforeach
            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll('.aksara-checkbox, .wilayah-checkbox')
