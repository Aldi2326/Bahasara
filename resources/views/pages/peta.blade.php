...
@section('title', 'Peta Bahasa Provinsi Jambi')
    ...
    <div style="position: relative;">
        ...
        <div id="legendCard" class="legend-card shadow">
            ...
            <div id="legendContent" class="legend-content">
                @foreach ($bahasaList->unique('nama_bahasa') as $b)
                <div class="legend-item">
                    <span class="legend-color" style="background: {{ $b->warna_pin ?? '#1E90FF' }}"></span>
                    {{ $b->nama_bahasa }}
                </div>
                @endforeach
            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll('.bahasa-checkbox, .wilayah-checkbox')
        ...
        bahasaList.forEach(b => {
            console.log(b);
            if (b.lat && b.lng) {
                // gunakan warna pin dari kolom database (misalnya b.warna_pin)
                const warna = b.warna_pin || '#1E90FF';

                // buat marker custom berbentuk pinpoint
            ...
            `,
                    iconSize: [24, 24],
                    iconAnchor: [12, 24], // titik bawah pin jadi pusat lokasi
                    popupAnchor: [0, -20]
                });
                ...
                <div style="background:linear-gradient(135deg,#ffffff 0%,#f9fafb 100%);
                    ...
                    <div style="border-bottom:1px solid #eee; padding-bottom:6px; margin-bottom:6px;">
                        <strong style="font-size:16px; color:#1e40af;">${b.nama_bahasa.nama_bahasa}</strong>
                    </div>
