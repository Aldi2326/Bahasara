        ...
        <div class="p-6">
            ...
            <form class="flex flex-col gap-4" method="POST" action="{{ route('sastra.update', $sastra->id) }}">
                ...
                <div class="grid grid-cols-4 items-center gap-6">
                    ...
                    <div class="md:col-span-3">
                        <input type="text" value="{{ $sastra->koordinat }}" name="koordinat" id="koordinat"
                            class="form-input" placeholder="Klik pada peta untuk mengisi koordinat" readonly required>
