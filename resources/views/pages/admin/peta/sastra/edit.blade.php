        ...
        <form class="flex flex-col gap-4" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-4 items-center gap-6">
                ...
                <div class="md:col-span-3">
                    <input type="text" name="nama_sastra" id="nama_sastra" class="form-input" placeholder="Contoh: Gurindam Dua Belas" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-4 items-start gap-6">
                ...
                <div class="md:col-span-3">
                    <textarea name="deskripsi" id="deskripsi" rows="8" class="form-input" placeholder="Tuliskan deskripsi sastra..." required></textarea>
                </div>
            </div>
            ...
            <div class="grid grid-cols-4 items-center gap-6">
                ...
                <div class="md:col-span-3">
                    <input type="text" name="koordinat" id="koordinat" class="form-input" placeholder="Klik pada peta untuk mengisi koordinat" readonly required>
                    <p class="mt-1 text-xs text-default-500">Klik titik pada peta di bawah untuk memilih koordinat lokasi.</p>
                </div>
            </div>
