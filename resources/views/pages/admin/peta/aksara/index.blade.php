                    ...
                    @forelse ($aksara as $index => $item)
                        <tr class="hover:bg-gray-50 transition text-center">
                            ...
                            <td class="px-4 py-3 text-center">
                                @if ($item->dokumentasi)
                                    @php
                                        $filePath = Storage::disk('public')->exists($item->dokumentasi)
                                            ? Storage::url($item->dokumentasi)
                                            : null;
                                    @endphp

                                    @if ($filePath)
                                        <img src="{{ $filePath }}" alt="dokumentasi" width="80"
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="px-6 py-5 text-center text-gray-500 italic">
                                Belum ada data aksara yang tersedia.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
