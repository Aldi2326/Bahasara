...
<div class="card overflow-hidden">
    <div class="card-header flex justify-between items-center">
        ...
        <a href="{{ route('aksara.index') }}" class="btn bg-gray-600 text-white">Kembali</a>
    </div>
    ...
    <div class="p-6 space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="text-base font-semibold text-default-800">{{ number_format($aksara['jumlah_penutur']) }} Penutur</p>
            </div>
        ...
        <div class="pt-4 border-t border-default-200 flex justify-end space-x-3">
            <a href="{{ route('aksara.edit', $aksara->id) }}" class="btn bg-blue-600 text-white">Edit</a>
            <form action="{{ route('aksara.destroy', $aksara->id) }}" method="POST" class="inline">
                @csrf
                                                @method('DELETE')
