    ...
    <div class="card">
        ...
        <div class="p-6">
            ...
            <form class="flex flex-col gap-4" method="POST" action="{{ route('aksara.store') }}" enctype="multipart/form-data">
                ...
                <!-- Jumlah Pengguna -->
                <div class="grid grid-cols-4 items-center gap-6">
                    <label for="jumlah_pengguna" class="text-default-800 text-sm font-medium">Jumlah Penutur Aksara</label>
                    <div class="md:col-span-3">
                        <input type="number" name="jumlah_penutur" id="jumlah_pengguna" class="form-input"
