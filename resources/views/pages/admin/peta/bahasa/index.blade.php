            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition" id="tr_{{ $item->id }}">
                    ...
                    <td class="px-4 py-3 whitespace-nowrap">
                        <span class="inline-flex items-center justify-center px-3 py-1 rounded-full text-xs font-medium text-white"
                    ...
                    <td class="px-4 py-3 text-blue-600">
                        ...
                        <a href="{{ $item->dokumentasi_yt }}" target="_blank" class="hover:underline">
                            Lihat Video
                        </a>
                        @else
                        -
                    ...
                    <td class="px-4 py-3">
                        <div class="flex justify-center gap-2">
                            ...
                            <form action="{{ route('bahasa.destroy', $item->id) }}" method="POST" class="inline delete-form">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="10" class="px-6 py-5 text-center text-gray-500 italic">
...
<form id="form-bulk-delete" action="{{ route('bahasa.bulk_delete') }}" method="POST" class="hidden">
    @csrf
    @method('DELETE')
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Fungsi untuk update tampilan tombol bulk delete
        ...
        allCheckboxes.forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                // Jika salah satu unchecked, matikan select all
                if (!this.checked) {
                    selectAllCheckbox.checked = false;
                }
                // Jika semua checked, nyalakan select all
        ...
        // Event Listener: Klik Tombol Hapus Terpilih
        bulkDeleteBtn.addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Masukkan ID ke input hidden dan submit form
