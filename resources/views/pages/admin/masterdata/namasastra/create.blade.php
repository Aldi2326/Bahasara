...
@section('content')
    <div class="card">
        ...
        <div class="p-6">
            <form class="flex flex-col gap-4" method="POST" action="{{ route('wilayah.store') }}"
                enctype="multipart/form-data">
                @csrf

                <!-- Nama Bahasa -->
                <div class="grid grid-cols-4 items-center gap-6">
                    <label for="nama_bahasa" class="text-default-800 text-sm font-medium">Nama Sastra</label>
                    <div class="md:col-span-3">
                        <input type="text" name="nama_wilayah" id="nama_bahasa" class="form-input"
