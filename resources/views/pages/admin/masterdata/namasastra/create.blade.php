...
<div class="flex items-center gap-3 text-sm font-semibold mb-5">
        ...
        <p class="text-sm font-bold text-default-900">Input Nama Sastra</p>
    </div>
<div class="card">
    ...
    <div class="p-6">
        <form id="namaSastraForm" class="flex flex-col gap-4" method="POST" action="{{ route('nama-sastra.store') }}" enctype="multipart/form-data">
            @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const form = document.getElementById('namaSastraForm');
