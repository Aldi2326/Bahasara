...
@section('title', 'Edit Nama Bahasa')
...
<div class="flex items-center gap-3 text-sm font-semibold mb-5">
        ...
        <p class="text-sm font-bold text-default-900">Edit Nama Bahasa</p>
    </div>
<div class="card">
    <div class="card-header">
        <h4 class="card-title mb-4">Edit Nama Bahasa</h4>
    </div>
            ...
            <div class="grid grid-cols-4 items-center gap-6">
                ...
                <div class="md:col-span-3">
                    <input type="text" name="nama_bahasa" id="nama_bahasa" class="form-input"
                        value="{{ old('nama_bahasa', $namaBahasa->nama_bahasa) }}" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-4 items-center gap-6">
                ...
                <div class="md:col-span-3 flex items-center gap-4">
                    <input type="color" name="warna_pin" id="warna_pin" class="w-16 h-10 cursor-pointer border rounded"
                        value="{{ old('warna_pin', $namaBahasa->warna_pin) }}">

                    <!-- Preview ikon pinpoint -->
                    <div id="pin-preview" class="flex items-center gap-2">
                        <svg id="pin-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" fill="{{ old('warna_pin', $namaBahasa->warna_pin) }}">
