    ...
    <div class="p-6 space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-base font-semibold text-default-800">{{ $pengumuman->judul ?? '-' }}</p>
            </div>
        ...
        <div class="pt-4 border-t border-default-200 flex justify-end space-x-3">
            ...
            <!-- Tombol Delete -->
            <form id="deleteForm" action="{{ route('pengumuman.destroy', $pengumuman->id) }}" method="POST" class="inline">
                @csrf
                @method('DELETE')
