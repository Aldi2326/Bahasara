                                    ...
                                    <tr class="odd:bg-white even:bg-default-100">
                                        ...
                                        <td class="px-6 py-4 text-sm text-default-800">
                                            @if ($item->file_geojson)
                                                <a href="{{ asset($item->file_geojson) }}" download
                                        ...
                                        <td class="px-6 py-4 text-sm text-default-800 space-x-2">
                                            <a href="{{ route('bahasa.index', ['wilayah_id' => $item->id]) }}"
                                                class="text-green-600 hover:underline">+ Bahasa</a>
                                            <a href="{{ route('sastra.index', ['wilayah_id' => $item->id]) }}"
                                                class="text-orange-600 hover:underline">+ Sastra</a>
                                            <a href="{{ route('aksara.index', ['wilayah_id' => $item->id]) }}"
                                                class="text-purple-600 hover:underline">+ Aksara</a>
