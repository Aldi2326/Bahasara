...
@section('content')
    ...
    <form id="form-bulk-delete" action="{{ route('wilayah.bulk_delete') }}" method="POST" class="hidden">
        @csrf
        @method('DELETE')
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            bulkDeleteBtn.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    text: `Anda akan menghapus ${allIds.length} data wilayah. Data tidak bisa dikembalikan!`,
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#DC2626',
                    cancelButtonColor: '#4B5563',
