...
<div class="card">
    ...
    <div class="p-6">
        ...
        <form class="flex flex-col gap-4" method="POST" action="{{ route('wilayah.update', $wilayah->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Nama Bahasa -->
            ...
            <div class="grid grid-cols-4 items-center gap-6">
                ...
                <div class="md:col-span-3">
                    <input type="file" name="file_geojson" id="geojson_file" class="form-input" accept=".geojson,application/geo+json">
